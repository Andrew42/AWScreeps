var createWorkers = {
    ...
    run: function(spawn,harvesters,builders,upgraders,janitors,miners,transporters,max_creeps) {
        ...
        var builder_template   = [WORK,WORK,CARRY,CARRY,MOVE,MOVE];
        var upgrader_template  = [WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE];
        var janitor_template   = [WORK,CARRY,CARRY,MOVE,MOVE];
        var harvester_template = [CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE];
        var transporter_template = [CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE];
        ...
        console.log('Transporters: ' + transporters.length + '/' + min_transporters);
